    ...
    <div class=" w-full h-screen flex-auto flex-col gap-y-4 bg-slate-100 overflow-y-scroll">
        ...
        <div class="m-6 bg-white w-auto h-auto pl-7 pr-7 pb-8 pt-7 ml-6 mr-6 mt-8 rounded-xl shadow-lg">
            ...
            <div class="mt-2 mb-20 flex justify-end">
                <a href=""><button type="button" class=" flex item-center justify-center py-2 px-3 mr-2 mb-2 text-sm font-medium text-white focus:outline-none bg-red-600 rounded-lg border border-gray-200 hover:bg-red-400 hover:text-gray-200 focus:z-10 focus:ring-4 focus:ring-red-300 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                ...
                <a href="\pengesahanpenelitian"><button type="button" class=" flex item-center justify-center py-2 px-3 mr-2 mb-2 text-sm font-medium text-white focus:outline-none bg-green-900 rounded-lg border border-gray-200 hover:bg-green-700 hover:text-gray-200 focus:z-10 focus:ring-4 focus:ring-green-400 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <div class="text-sm font-medium text-gray-700 mb-5">
                ...
                <div class="grid grid-cols-6 md:grid-cols-3 gap-0 pr-8 mb-3">
                    ...
                    <div></div>
                    <div class="w-full">
                        <p ><span class="mr-2 pl-4">a.</span>Nama Mahasiswa (1) / NIM</p>
                    </div>
                    <div class="w-full h-auto flex">
                        <span class="mr-1">:</span>
                        <p><span>Nurwahida</span><span> / </span><span>1904411225</span></p>
                    </div>
                    <div></div>
                    <div class="w-full">
                        <p ><span class="mr-2 pl-4">b.</span>Nama Mahasiswa (2) / NIM</p>
                    </div>
                    <div class="w-full h-auto flex">
                        <span class="mr-1">:</span>
                        <p><span>Siti Nurwahida</span><span> / </span><span>1904411243</span></p>
                    </div>
                    <div></div>
