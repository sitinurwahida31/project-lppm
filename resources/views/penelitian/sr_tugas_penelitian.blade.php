...
<body>
    ...
    <div class=" w-full h-screen flex-auto flex-col gap-y-4 bg-slate-100 overflow-y-scroll">
        ...
        <div class="m-6 bg-white w-auto h-auto pl-5 pr-5 pb-8 pt-6 ml-6 mr-6 mt-8 rounded-xl shadow-lg">
            <div class="items-center gap-x-4 sm:flex justify-between">
                <div class="sm:mb-0 mb-4 ">
                    <a href="/surat-penelitian-export" class="mt-2 text-white flex gap-1 bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-normal rounded-md text-base px-4 py-1.5 pb-1 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
