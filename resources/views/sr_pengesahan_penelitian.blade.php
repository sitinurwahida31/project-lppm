...
<body>
    ...
    <div class=" w-full h-screen flex-auto flex-col gap-y-4 bg-slate-100 overflow-y-scroll">
        ...
        <div class="bg-white h-9 w-auto m-6 mt-8 rounded-lg shadow-lg flex-row flex items-center">
            <span class="text-green-700 font-bold pl-5 text-sm sm:flex">DATA SURAT PENGESAHAN PENELITIAN</span>
        </div>
                ...
                <table class="w-full text-xs text-center text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <th scope="row" class="px-6 py-1 font-normal text-gray-900 whitespace-nowrap dark:text-white">
                            ...
                            <td class="px-6 py-1 flex justify-center">
                                <a href="#" class="font-medium text-green-700 dark:text-gray-500 hover:underline m-1">
                                ...
                                <a href="#" class="font-medium text-blue-500 dark:text-gray-500 hover:underline m-1">
