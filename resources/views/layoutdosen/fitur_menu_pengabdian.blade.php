    ...
    <div class="m-16 mb-20 mt-12 bg-white shadow-lg w-auto h-auto pb-20">
        ...
        <div class="flex justify-center items-center mb-20">
            ...
            <div class="grid grid-cols-2 gap-16 w-auto px-7">
                {{-- fitur add --}}
                <a href="/pengabdian/inputpengabdian" class=" w-24 h-24 drop-shadow-lg bg-green-800 border bg-red hover:bg-amber-400 focus:outline-none focus:ring-4 focus:ring-amber-300 font-medium rounded-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 text-amber-400 hover:text-white">
                ...
                {{-- fitur arsip --}}
                <a href="/pengabdian/arsipdosen" class=" w-24 h-24 drop-shadow-lg bg-green-800 border bg-red hover:bg-amber-400 focus:outline-none focus:ring-4 focus:ring-amber-300 font-medium rounded-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 text-amber-400 hover:text-white">
