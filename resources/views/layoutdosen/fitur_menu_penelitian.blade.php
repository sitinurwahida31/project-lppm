        ...
        <div class="md:col-span-2 shadow  md:rounded-l-full bg-white mt-16 pb-20 md:mt-0">
                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            ...
                            <span class="ml-1 text-base font-medium text-gray-500 md:ml-2 dark:text-gray-400">Penelitian</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex justify-center mt-1 md:mt-7 my-4 md:ml-32 ml-0">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-14 md:grid md:grid-cols-2 md:gap-10 ">
                    <a href="/penelitian/inputpenelitian" class="rounded-xl w-auto px-7 py-3 md:p-5 bg-white shadow-md shadow-gray-400 focus:ring-4 focus:ring-gray-200 text-gray-700 focus:text-[#4caf50] hover:bg-gray-100 hover:text-[#4caf50]">
                    ...
                    <a href="/penelitian/arsipdosen" class="rounded-xl w-auto px-7 py-3 md:p-5 bg-white shadow-md shadow-gray-400 focus:ring-4 focus:ring-gray-200 text-gray-700 focus:text-[#4caf50] hover:bg-gray-100 hover:text-[#4caf50]">
                        <div class="flex justify-center pt-3">
                            <img class="pb-2 w-36 md:w-48 h-auto" src="img/icons/fitmearsip.svg" alt="">
                        </div>
                        <p class="text-sm font-semibold text-center pt-3">Arsip Penelitian</p>
                    </a>
