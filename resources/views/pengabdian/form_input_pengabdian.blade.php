    ...
    <div class="flex justify-end items-center mb-14 mt-20 mr-16">
        <nav class="flex mt-2" aria-label="Breadcrumb">
            ...
            <li aria-current="page">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Form</span>
                </div>
            </li>
            </ol>
        </nav>
    ...
    <form action="/storesuratpengabdian" method="post">
        ...
        <div class=" mt-20 ml-28 mr-28 mb-10 rounded-b-lg drop-shadow-lg bg-white pt-8">
            ...
            <div action="" class="p-8">
                ...
                {{-- row 2 --}}
                <div class="mb-4">
                    <label for="judul_pengabdian" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Judul Pengabdian</label>
                    <textarea id="judul_pengabdian" required name="judul_pengabdian" rows="4" class="@error('judul_pengabdian')border-red-400 @enderror block pl-3 pt-2 pb-2 p-1 w-full h-16 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Judul pengabdian">{{ old('judul_pengabdian') }}</textarea>
                ...
                <div class="grid gap-6 mb-4 md:grid-cols-3">
                    <div>
                        <label for="jangka_waktu" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Jangka Waktu Pengabdian</label>
                ...
                <div>
                    ...
                    <select id="sumberdana" required name="sumberdana" class="border-gray-300  @error('sumberdana')border-red-400 @enderror block w-full p-1 mb-1 text-sm text-gray-900 border rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value=""></option>
                ...
                <div class="grid gap-6 mb-4 md:grid-cols-2">
                    <div>
                        <label for="biaya_pengabdian" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Biaya Pengabdian</label>
        ...
        <div class="mt-14 ml-28 mr-28 mb-10 rounded-sm shadow-lg bg-white pt-8">
            ...
            <div action="" class="p-8">
                <div class="grid gap-6 mb-6 md:grid-cols-2 ">
                    <div>
                        <label for="nama_anggota1" required class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama Anggota 1</label>
        ...
        <div class=" flex justify-end mt-14 ml-28 mr-28 mb-16">
            <button type="reset" class="py-1 px-5 mr-2 mb-2 text-sm font-medium text-white focus:outline-none bg-red-700 rounded-lg border border-gray-200 hover:bg-red-400 hover:text-gray-200 focus:z-10 focus:ring-4 focus:ring-red-300 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                Reset
            </button>
