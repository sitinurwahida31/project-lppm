...
<body>
    ...
    <div class="m-6 bg-white w-auto h-auto pl-5 pr-5 pb-8 pt-3 ml-16 mr-16 mt-20 mb-16 rounded-xl shadow-lg">
        ...
        <div class=" flex justify-end mt-14">
            <a href="/fitur">
                <button type="button" class="py-1 px-3 mr-2 mb-2 text-sm font-medium text-white focus:outline-none bg-gray-500 rounded-lg border border-gray-200 hover:bg-gray-500 hover:text-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-400 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Back</button>
            </a>
        </div>
