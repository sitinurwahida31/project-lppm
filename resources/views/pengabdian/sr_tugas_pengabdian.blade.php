...
<body>
    ...
    <div class=" w-full h-screen flex-auto flex-col gap-y-4 bg-slate-100 overflow-y-scroll">
        ...
        <div class="bg-white h-9 w-auto m-6 mt-8 rounded-lg shadow-lg flex-row flex items-center">
            <span class="text-green-700 font-bold pl-5 text-sm sm:flex ">DATA PENGABDIAN</span>
        </div>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-1 justify-center h-full ">
                                <div class="flex items-stretch h-full place-items-center">
                                    {{-- icon edit --}}
                                    <a href="/surattugas/pengabdian/detailsuratpengabdian/{{ $data->id }}" class="p-1 text-white bg-blue-500 m-0.5" >
