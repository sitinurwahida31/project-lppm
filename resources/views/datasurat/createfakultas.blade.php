    ...
    <div class="flex-col flex-auto w-full h-screen overflow-y-scroll gap-y-4 bg-slate-100">
        ...
        <div class="flex flex-row items-center w-auto m-6 mt-8 bg-white rounded-lg shadow-lg h-9">
            <span class="pl-5 text-sm font-bold text-green-700 sm:flex ">
                DATA SURAT/ <span class="italic text-green-500">Create Fakultas</span>
            </span>
        </div>
        ...
        <div class="pt-4 m-6 mb-10 bg-white rounded-lg drop-shadow-lg">
            ...
            <form action="/storefakultas" method="post" class="p-8 pb-4">
                @csrf
                <div class="grid gap-6 lg:mx-14 md:mx-10 md:grid-cols-1">
                    <div>
                        ...
                        <input type="text" required id="namafakultas" name="namafakultas" value="{{ old('namafakultas')}}"
                            class="
                    ...
                    <div>
                        ...
                        <input type="text" required id="nama_dekan" name="nama_dekan" value="{{ old('nama_dekan')}}"
                            class="
                    ...
                    <div>
                        ...
                        <input type="number" required id="nidn_dekan" name="nidn_dekan" value="{{ old('nidn_dekan')}}" 
                            class="
