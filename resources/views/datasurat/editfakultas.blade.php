    ...
    <div class="flex-col flex-auto w-full h-screen overflow-y-scroll gap-y-4 bg-slate-100">
        ...
        <div class="flex flex-row items-center w-auto m-6 mt-8 bg-white rounded-lg shadow-lg h-9">
            <span class="pl-5 text-sm font-bold text-green-700 sm:flex ">
                DATA SURAT/ <span class="italic text-green-500">Edit Fakultas</span>
            </span>
        </div>
        ...
        <div class="pt-4 m-6 mb-10 bg-white rounded-lg drop-shadow-lg">
            ...
            <form action="/updatefakultas/{{ $fakultas->id }}" method="post" class="p-8 pb-4">
                @csrf
                <div class="grid gap-6 lg:mx-14 md:mx-10 md:grid-cols-1">
                    <div>
                        <label for="namafakultas"
                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama Fakultas</label>
                        <input type="text" required id="namafakultas" name="namafakultas" value="{{ old('namafakultas', $fakultas->nama_fakultas)}}"
                            class="
                        @error('namafakultas')border-red-400 @enderror
                    ...
                    <div>
                        <label for="nama_dekan"
                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama Dekan</label>
                        <input type="text" required id="nama_dekan" name="nama_dekan" value="{{ old('nama_dekan', $fakultas->nama_dekan)}}"
                            class="
                        @error('nama_dekan')border-red-400 @enderror
                         bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1 pl-3 py-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Nama Program Studi">
                        <div class="text-sm italic text-red-500">
                            @error('nama_dekan')
                    ...
                    <div>
                        <label for="nidn_dekan"
                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">NIDN/NID</label>
                        <input type="number" required id="nidn_dekan" name="nidn_dekan" value="{{ old('nidn_dekan', $fakultas->nomor_induk_dekan)}}" 
                            class="
                            @error('nidn_dekan')border-red-400 @enderror 
